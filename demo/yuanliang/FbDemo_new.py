...
time_ranges = [{'since': '2018-06-21', 'until': '2018-06-22'},
{'since': '2018-06-22', 'until': '2018-06-23'},
{'since': '2018-06-23', 'until': '2018-06-24'},
{'since': '2018-06-24', 'until': '2018-06-25'},
{'since': '2018-06-25', 'until': '2018-06-26'},
{'since': '2018-06-26', 'until': '2018-06-27'},
{'since': '2018-06-27', 'until': '2018-06-28'},
{'since': '2018-06-28', 'until': '2018-06-29'},
{'since': '2018-06-30', 'until': '2018-07-01'},
{'since': '2018-07-01', 'until': '2018-07-02'},
{'since': '2018-07-02', 'until': '2018-07-03'},
{'since': '2018-07-03', 'until': '2018-07-04'},
{'since': '2018-07-04', 'until': '2018-07-05'},
]
...
# 获取广告统计信息
def fetch_ad_data(ad_id, timerange):
    ad = Ad(ad_id)
...
# 获取广告组统计信息
def fetch_adset_data(adset_id,timerange):
...
# 获取广告系列统计信息
def fetch_campaign_data(campaign_id, timerange):
    ...
    for account in accounts:
        ...
        for adcampaign in adcampaigns:
            ...
            if adcampaign['status'] == 'ACTIVE':
                ...
                for timerange in time_ranges:
                    campaign_stats = fetch_campaign_data(adcampaign['facebook_ad_campaign_id'], timerange)
        ...
        for adset in adsets:
            ...
            if adset['status'] == 'ACTIVE':
                for timerange in time_ranges:
                    adset_stats = fetch_adset_data(adset['facebook_adset_id'], timerange)                
        ...
        for ad in ads:
            ...
            if ad['status'] == 'ACTIVE':
                for timerange in time_ranges:
                    ad_stats = fetch_ad_data(ad['facebook_ad_id'], timerange)
